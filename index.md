...
- Action recognition (with [Google Research](https://research.google/))
    + Developed an efficient action recognition system that captures long-range dependencies in videos.
